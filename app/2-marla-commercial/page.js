    ...
    return (
        <>
            <div className='min-h-screen'>
                ...
                <div className="md:text-3xl text-2xl tracking-widest px-10 flex justify-between text-green-900"><span>Details?</span> <span>Pictures?</span> <span>Benefits?</span></div>
                <div className="border my-3"></div>
                {/* Contact Page */}
