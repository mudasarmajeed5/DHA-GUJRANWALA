    ...
    return (
        <>
            <div className='min-h-screen'>
                ...
                <div className='py-10'>
                    <h1 className="text-3xl lg:text-4xl text-center text-[--secondary-button] font-bold my-5">2 Marla Commercial by DHA Gujranwala</h1>
                ...
                <section className="text-[--secondary-button] body-font relative">
                    <div className="container px-5 py-1 mx-auto flex sm:flex-nowrap flex-wrap">
                        ...
                        <div className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                            <h2 className="text-4xl text-[--text-button] mb-1 uppercase font-medium title-font">
                                Get in Touch
                            </h2>
                            <div className="relative mb-4">
                                <label htmlFor="name" className="leading-7 text-sm text-[--text-color]">
                                    Name
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="relative mb-4">
                                <label htmlFor="phone" className="leading-7 text-sm text-[--text-color]">
                                    Phone
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="relative mb-4">
                                <label htmlFor="email" className="leading-7 text-sm text-[--text-color]">
                                    Email
                                </label>
                                <input
                                    type="email"
                            ...
                            <div className="relative mb-4">
                                <label htmlFor="message" className="leading-7 text-sm text-[--text-color]">
                                    Message
                                </label>
                                <textarea
                            ...
                            <button className="text-white bg-[--secondary-button] border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg font-bold">
                                SUBMIT
                            </button>
                ...
                <div
                    ...
                    <button className="border rounded-full bg-transparent border-[--secondary-button] shadow-md hover:shadow-green-500 transition-all text-white px-4  py-1 flex items-center gap-1"><lord-icon
                    ...
                    <button className="border flex gap-1 items-center rounded-full bg-transparent border-[--secondary-button] shadow-md hover:shadow-green-500 transition-all text-white px-4 py-1"><lord-icon
